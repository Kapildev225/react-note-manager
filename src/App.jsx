...
function App(){ 
  ...
  return(
    ...
    <div className={`app ${darkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      {/* <Delete deleteNote={deleteNote}/> */}
    </div>
    <div className="toast-container">
      <ToastContainer position="top-right" autoClose={3000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false}  theme={darkMode ? 'dark' : 'light'} />
    </div>
  </>
  )
}
